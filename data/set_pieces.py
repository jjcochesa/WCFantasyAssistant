...
SET_PIECES = {
    ...
    "CAN": {"PK": ["David"],                "FK": ["Davies"],                "CK": ["Davies", "Choiniere"]},
    ...
    "GHA": {"PK": ["Ayew"],                 "FK": ["Ayew", "Semenyo"],       "CK": ["Ayew"]},
    ...
    "JPN": {"PK": ["Ueda", "Doan"],         "FK": ["Kubo", "Ito"],           "CK": ["Ito"]},
