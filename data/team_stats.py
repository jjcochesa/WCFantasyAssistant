...
PROJ_GOALS = {
    "ESP": [3.24, 2.88, 1.82], "GER": [4.03, 1.94, 1.79], "BRA": [1.74, 3.65, 2.14],
    "FRA": [1.98, 3.00, 1.60], "POR": [2.40, 2.46, 1.48], "ENG": [1.63, 2.23, 2.46],
    "ARG": [1.98, 1.75, 2.63], "BEL": [1.84, 2.01, 2.33], "SUI": [2.39, 1.80, 1.44],
    "NED": [1.57, 1.76, 1.82], "MEX": [1.82, 1.49, 1.54], "NOR": [2.54, 1.49, 0.96],
    "URU": [1.93, 1.98, 0.87], "COL": [1.94, 1.79, 1.03], "AUT": [2.32, 0.84, 1.35],
    "USA": [1.42, 1.61, 1.32], "CAN": [1.54, 2.09, 1.07], "ECU": [1.13, 2.18, 0.92],
    "MAR": [0.86, 1.31, 2.17], "CRO": [0.90, 1.81, 1.62], "TUR": [1.61, 1.29, 1.21],
    "CIV": [0.91, 0.91, 2.22], "JPN": [1.10, 1.51, 1.44], "EGY": [0.92, 1.59, 1.22],
    "SEN": [0.78, 1.12, 1.83], "SCO": [1.94, 0.93, 0.70], "CZE": [1.13, 1.43, 0.92],
...
CS_PCT = {
    "ESP": [0.65, 0.65, 0.42], "ARG": [0.51, 0.43, 0.59], "FRA": [0.46, 0.68, 0.38],
    "BRA": [0.44, 0.63, 0.50], "GER": [0.68, 0.42, 0.40], "ENG": [0.41, 0.51, 0.52],
    "POR": [0.53, 0.50, 0.36], "BEL": [0.40, 0.49, 0.54], "SUI": [0.54, 0.43, 0.34],
    "MEX": [0.53, 0.42, 0.40], "COL": [0.51, 0.55, 0.23], "NED": [0.33, 0.42, 0.46],
    "CAN": [0.42, 0.61, 0.24], "ECU": [0.41, 0.57, 0.17], "URU": [0.49, 0.51, 0.16],
    "CRO": [0.20, 0.47, 0.44], "USA": [0.41, 0.41, 0.30], "MAR": [0.17, 0.39, 0.51],
    "NOR": [0.57, 0.33, 0.20], "TUR": [0.40, 0.36, 0.27], "AUT": [0.48, 0.17, 0.33],
    "CIV": [0.31, 0.15, 0.55], "EGY": [0.16, 0.46, 0.40], "JPN": [0.21, 0.42, 0.34],
    "CZE": [0.30, 0.41, 0.21], "KOR": [0.32, 0.23, 0.36], "SCO": [0.48, 0.25, 0.12],
